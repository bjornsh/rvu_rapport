...
* *rapportomrade*: en vektor av en eller flera strängar som definierar rapportens intresseområde. Detta används i dataanalysen och namnet måste överrensstämma med det namn som används i indatatabellerna. T.ex. "Uppsala län" eller c("Bålsta", "Bålsta Skärplinge")
