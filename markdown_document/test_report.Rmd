...
reslangd_barplot <- ggplot(reslangd_per_fardmedel, aes(factor(Färdmedel, level = ordning_fardmedel), perc_reslangd, fill = factor(Färdmedel, level = ordning_fardmedel))) +
    ...
    labs(
        ...
        title = "Andel färdmedelskilometer per färdmedel"
    )
...
```{r delresor-diagram, echo = FALSE, results = "asis", fig.cap = "Kombinationsresor för kollektivtrafiksresor."}
...
kombiresor_barplot <- ggplot(kollresor_kombination_plot, aes(factor(sek_fardmedel, level = sek_fardmedel), Perc_resor, fill = factor(sek_fardmedel, level = sek_fardmedel))) +
    ...
    labs(
        x = "Färdmedel",
        y = "Andel resor",
        title = "Anslutningsresor för kollektivtrafiksresor"
    )
kombiresor_barplot
```

```{r delresor2-diagram, echo = FALSE, results = "asis", fig.cap = "Kombinationsresor för kollektivtrafiksresor."}
#Histogram med resandefrekvens
kombiresor_barplot <- ggplot(resor_kombination_plot, aes(factor(sek_fardmedel, level = sek_fardmedel), Perc_resor, fill = factor(sek_fardmedel, level = sek_fardmedel))) +
    ...
    labs(
        x = "Färdmedel",
        y = "Andel resor",
        title = "Kombinationsresor i andel av alla resor"
    )
kombiresor_barplot
```
...
area_max_fk_km <- area_max_fk["Totalt antal färdmedelskilometer"]
area_min_fk_km <- area_min_fk["Totalt antal färdmedelskilometer"]
```
...
I `r area_max_fk$Område` gjordes den största sammanlagda förflyttningen på `r round(area_max_fk_km) ` kilometer, medan `r area_min_fk$Område` stod för den minsta sammanlagda förflyttningen på (`r round(area_min_fk_km)` kilometer).
