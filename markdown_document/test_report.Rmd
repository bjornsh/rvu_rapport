...
Män och kvinnor gör ungefär lika många resor per person och dag, `r num_trips_men ` respektive `r num_trips_women`. Män använder bil i högre utsträckning än kvinnor, `r share_care_men*100` procent jämfört med `r share_care_women*100` procent. Kvinnor färdas i större utsträckning med kollektivtrafik än män `r share_transit_women`, respektive `r share_transit_men` procent. Kvinnor och män cyklar i ungefär lika stor utsträckning, `r share_bike_women` procent respektive `r share_bike_men` procent.
...
Andelen cykelresor är högst i åldersgruppen `r max_bike_age$Ålder`, där `r max_bike_age$Andel*100 ` procent av resorna utförs med cykel. Andelen bilresor ökar med stigande ålder och är högst i ålderskategorin `r max_car_age$Ålder`, där `r max_car_age$Andel*100` procent av resorna utfördes med bil. Den högsta andelen bussresor är i ålderskategorin `r max_bus_age$Ålder` där `r max_bus_age$Andel*100` procent av resorna utförs med buss. 
