...
rapportomrade <- "Uppsala" #c("Bålsta", "Bålsta Skärplinge") #c("Bålsta", "Bålsta Skärplinge") #"Uppsala län" #Sträng eller array över områden som inkluderas
rapportomrade_text <- "Uppsala kommun" #"Bålsta" #"Uppsala län"  #namn på området som skrivs i löptexten
rapportomrade_rubrik <- "Uppsala kommun" #"Bålsta tätort" #"Uppsala län" #namn på området som skrivs i rubriker
...
od_matrix <- od_matrix %>%
  select(start_omrade_namn,lista_med_omraden[0:minsta_antal+1],Totalt) %>%
...
x <- kable(resp_over_tid, caption = "Antal respondenter per månad under enkätundersökningens period.", booktabs = T, linesep = "",format.args = list( big.mark = " ")) %>%
...
x <- kable(od_matrix_perc, caption = paste0("Fördelning av resorna inom ",rapportomrade_text,". Radrubriker visar var resar börjar och kolumnrubriker visar var resan slutar."), booktabs = T, linesep = "",format.args = list( big.mark = " ")) %>%
  kable_styling(latex_options = c("striped", "HOLD_position")) %>%
                # full_width = TRUE) %>%
