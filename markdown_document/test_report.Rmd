...
rapportomrade <- c("Bålsta", "Bålsta Skärplinge") #c("Bålsta", "Bålsta Skärplinge") #"Uppsala län" #Sträng eller array över områden som inkluderas
rapportomrade_text <- "Bålsta" #"Bålsta" #"Uppsala län"  #namn på området som skrivs i löptexten
rapportomrade_rubrik <- "Bålsta tätort" #"Bålsta tätort" #"Uppsala län" #namn på området som skrivs i rubriker
